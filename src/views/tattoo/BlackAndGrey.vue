  ...
  data() {
    return {
      ...
      allImages: [
        ...
        { id: 5, src: require('@/assets/image/tattoo/blackandgrey/blackandgrey5.jpg'), alt: 'BlackAndGrey 5', title: 'hannya & samurai RAIDEN [Mortal Kombat]' },
        { id: 4, src: require('@/assets/image/tattoo/blackandgrey/blackandgrey4.jpg'), alt: 'BlackAndGrey 4', title: 'Apollonhannya & samurai' },
